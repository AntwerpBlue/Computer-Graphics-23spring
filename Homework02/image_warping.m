...
figure('Units', 'pixel', 'Position', [100,100,1000,700], 'toolbar', 'none');%create a new window
subplot(121); imshow(im); title({'Source image', 'Press the red tool button to add point-point constraints'});%create an area
...
hToolWarp = uipushtool('CData', reshape(repmat([0 0 1], 100, 1), [10 10 3]), 'TooltipString', 'compute warped image', ...
                       'ClickedCallback', @toolWarpCB);%create 2 buttons
